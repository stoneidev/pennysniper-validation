"""
Generate daily breakout reports for every trading day in May 2025.

Uses rule trained on 2025.01-03 (= rule_2025_q2.json).
"""
import subprocess
import sys
...
RULE = REPO / "config" / "rule_2025_q2.json"

# Iterate every weekday in May 2025
start = pd.Timestamp("2025-05-01")
end = pd.Timestamp("2025-05-30")
dates = pd.date_range(start, end, freq="B")  # business days

print(f"Generating reports for {len(dates)} trading days in May 2025")
